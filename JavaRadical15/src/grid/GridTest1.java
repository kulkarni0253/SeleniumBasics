...
public class GridTest1 {
	 ...
	 * 
	 * Nodes should register to http://192.168.1.150:4444/grid/register/
	 * 
	 ...
	 * Node URL (ff+chrome)
	 * java -Dwebdriver.chrome.driver=" java -Dwebdriver.chrome.driver="webdriver.chrome.driver", "C:\Users\HarshalKulkarni\Desktop\Selenium_files\3rd June\chromedriver_win32_B39\chromedriver.exe" -jar selenium-server-standalone-3.5.2.jar -role node -hub http://192.168.1.150:4444/grid/register/ -browser "browserName=chrome,version=ANY,platform=WINDOWS,maxInstances=5" -maxSession 5" -Dwebdriver.gecko.driver="C:\\Users\\HarshalKulkarni\\Desktop\\Selenium_files\\3rd June\\geckodriver-v0.18.0-win64\\geckodriver.exe" -jar selenium-server-standalone-3.5.2.jar -role node -hub http://192.168.1.150:4444/grid/register/ -browser "browserName=firefox,version=ANY,platform=WINDOWS,maxInstances=5" -browser "browserName=chrome,version=ANY,platform=WINDOWS,maxInstances=5" -maxSession 5
	 * 
	 ...
	 * 
	 * Node URL (chrome)
	 * java -Dwebdriver.chrome.driver="webdriver.chrome.driver", "C:\chromedriver.exe" -jar selenium-server-standalone-3.5.2.jar -role node -hub http://192.168.1.105:4444/grid/register/ -browser "browserName=chrome,version=ANY,platform=WINDOWS,maxInstances=5" -maxSession 5
	 * 
	 * 
